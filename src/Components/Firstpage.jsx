...
//     { id: 4, name: "Spinach healthy meal", img: spinach, price: 20, available: 10 },
//     { id: 5, name: "Omelette rice", img: omleterice, price: 28, available: 12 },
//     { id: 6, name: "Special omelette", img: specialomlete, price: 30, available: 8 },
//     { id: 7, name: "Seafood noodles", img: seafoodnoodles, price: 32, available: 15 },
//     { id: 8, name: "Salted pasta", img: saltedpasta, price: 26, available: 20 },
//     { id: 9, name: "Beef dumpling soup", img: beef, price: 35, available: 5 },
//   ];
...
//     w-10 h-10 aspect-square min-w-40px min-h-40px
...
//                 className={`pb-3 relative cursor-pointer ${activeTab === tab.id
//                     ? "text-orange-500"
...
//                 {tab.label}
//                 {activeTab === tab.id && (
//                   <span className="absolute left-0 -bottom-px w-full h-0.5 bg-orange-500" />
//                 )}
//               </button>
//             ))}
//           </div>
...
//         {/* DISH LIST */}
//         <div className="flex-1 overflow-y-auto px-6 pb-6 hide-scrollbar  bg-[#1b2032]">
//           <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-24 pt-24  bg-[#1b2032]">
